...
![img](./assets/a2e311f60bc9dfa46cf6474eaf2f8278-1776468543731-11.png)

访问 http://127.0.0.1:8000/items/42?q=runoob 查看带路径参数和查询参数的响应：

![img](./assets/6a83565422bf2ed93c6db75fc3927ff8.png)

FastAPI 自动生成的交互式 API 文档将包括定义的路由信息、路径参数、查询参数等。访问文档地址 **http://127.0.0.1:8000/docs** 查看详细的文档和测试界面：

![img](./assets/index-01-swagger-ui-simple-1776468543731-14.png)