...
![img](./assets/a2e311f60bc9dfa46cf6474eaf2f8278.png)
...
| 工具                                                         | 说明                                                         |
| :----------------------------------------------------------- | :----------------------------------------------------------- |
| [VS Code](https://code.visualstudio.com/)                    | 免费、轻量，配合 Python 和 Pylance 插件有极佳的 FastAPI 开发体验 |
| [PyCharm](https://www.jetbrains.com/pycharm/)                | 专业 Python IDE，内置 FastAPI 项目模板和强大的调试功能       |
| [阿里 Qoder](https://qoder.com/users/sign-up?referral_code=whhACoCj9WryAtAh2HAqjvE2ppbzwWtz) | 阿里推出的 AI 编程 IDE，基于 VS Code 深度定制                |
| [字节 Trae](https://www.trae.cn/?utm_source=advertising&utm_medium=runoob_ug_cpa&utm_term=hw_trae_runoob) | 字节跳动推出的 AI 驱动开发工具，内置 Python 支持             |
